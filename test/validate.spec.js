...
test('validate should return true for valid reference with characters', (assert) => {
  const expected = true
...
test('validate should return false for invalid reference', (assert) => {
...
test('validate should return true for valid 25 char long reference', (assert) => {
  const expected = true
...
test('validate should return false for valid 26 char long reference', (assert) => {
  const expected = false
